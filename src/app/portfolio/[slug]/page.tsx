        ...
        <Container>
          ...
          <div className="mt-14 grid grid-cols-1 gap-8 lg:grid-cols-3">
            <Reveal className="card-surface rounded-2xl p-7">
              <h2 className="text-sm font-semibold uppercase tracking-[0.1em] text-muted-2">Challenge</h2>
              <p className="mt-4 text-sm leading-relaxed text-foreground/90">{project.challenge}</p>
            </Reveal>
            <Reveal delay={0.08} className="card-surface rounded-2xl p-7">
              <h2 className="text-sm font-semibold uppercase tracking-[0.1em] text-muted-2">Solution</h2>
              <p className="mt-4 text-sm leading-relaxed text-foreground/90">{project.solution}</p>
            </Reveal>
            <Reveal delay={0.16} className="card-surface rounded-2xl p-7">
              <h2 className="text-sm font-semibold uppercase tracking-[0.1em] text-muted-2">Outcome</h2>
              <p className="mt-4 text-sm leading-relaxed text-foreground/90">{project.outcome}</p>
            </Reveal>
          </div>

          <Reveal className="mt-14 flex flex-col gap-6 border-t border-border-subtle pt-10 sm:flex-row sm:justify-between">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-[0.1em] text-muted-2">Services Provided</h3>
