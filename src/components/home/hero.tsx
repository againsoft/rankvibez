      ...
      <Container className="relative">
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          <div className="flex flex-col items-start gap-7">
            <Badge>AI-First Technology Partner</Badge>
            <h1 className="text-4xl font-semibold leading-[1.08] tracking-tight text-foreground sm:text-5xl lg:text-[3.4rem]">
              Build the Future with{" "}
              <span className="text-gradient-brand">AI-Driven Technology</span>
            </h1>
            <p className="max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              RankVibez helps businesses build intelligent software, automate operations,
              strengthen infrastructure and accelerate digital growth through AI-powered technology.
            </p>
